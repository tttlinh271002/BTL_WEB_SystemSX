var factoryAPI = 'http://localhost:3000/factoryWarranty';
let currentPge = 1;
let perPage = 5;
let totalPage = 0;
let perUser = [];
...
function deleteStudent(id) {
    alert('Xóa thông tin sản phẩm trả về thành công');
    var options = {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json'
...
function addNew(){
    ...
    if (checkErrorElement) {
        ...
        alert('Thêm thông tin sản phẩm trả về thành công');
...
function changeStudent() {
    ...
    alert('Thay đổi thông tin sản phẩm trả về thành công');
}
