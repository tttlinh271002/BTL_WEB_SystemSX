var factoryAPI = 'http://localhost:3000/productFactoryInStock';
let currentPge = 1;
let perPage = 5;
let totalPage = 0;
let perUser = []
...
function deleteStudent(id) {
    alert('Xóa sản phẩm trong CS sản xuất thành công');
    var options = {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json'
...
function addNew(){
    ...
    if (checkErrorElement) {
        ...
        alert('Thêm sản phẩm trong CS sản xuất thành công');
...
function changeStudent() {
    ...
    alert('Thay đổi sản phẩm trong CS sản xuất thành công');
}
